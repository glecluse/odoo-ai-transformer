...
# !! AVERTISSEMENT : Ne jamais laisser une clé en clair.
# Ceci sera remplacé par st.secrets.
OPENAI_API_KEY = "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"

def get_ai_plan(user_prompt, document_text):
    """Interroge l'IA pour obtenir le plan de transformation (modèles et code)."""
    
    # Remplacer ceci par st.secrets["OPENAI_API_KEY"] lors du déploiement
...
def run_ai_code(ai_python_code, dataframes):
    """Exécute le code python généré par l'IA de manière sécurisée."""
